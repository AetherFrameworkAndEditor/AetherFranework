...
void Point::FinalizeBuffers(){

}

void Point::RenderBuffers(){
	unsigned int stride;
	unsigned int offset;
	...
	GetDirect3DManager()->GetDeviceContext()->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_POINTLIST);
}