...
bool Rectangle2D::InitializeBuffers(){
	...
	vertices[0]._uv = Vector2(0.0f, 0.0f);

	// Top middle
	vertices[1]._position = Vector3(0.0f, 1.0f, 0.0f);
	vertices[1]._uv = Vector2(0.0f, 1.0f);

	// BottomRight
	vertices[2]._position = Vector3(1.0f, 0.0f, 0.0f);
	vertices[2]._uv = Vector2(1.0f, 0.0f);

	// BottomRight
	vertices[3]._position = Vector3(1.0f, 1.0f, 0.0f);
	vertices[3]._uv = Vector2(1.0f, 1.0f);
...
void Rectangle2D::FinalizeBuffers(){

}

void Rectangle2D::RenderBuffers(){
	unsigned int stride;
	unsigned int offset;
	...
	// Set the type of primitive that should be rendered from this vertex buffer,in this case Rectangle2D
